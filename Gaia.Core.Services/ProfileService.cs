...
namespace Gaia.Core.Services
{
    public class ProfileService : IProfileService
    {
        ...
        private Dictionary<string, SystemSetting> _settingMap = null;
        public Dictionary<string, SystemSetting> SystemSettings => _settingMap ?? (_settingMap = DataContext?.Store<SystemSetting>().Query.ToDictionary(_st => _st.Name));
        ...
        => FeatureAccess.Guard(UserContext, () =>
        {
            ...
            else
            {
                ...
                AccessManager.ApplyAccessProfile(userId,
                                ...
                                .Then(opr => CreateRegistrationVerification(userId))

                                //construct the mail that gets sent to the user to verify his/her account
                                .Then(opr => MessagePush.Push(new AccountVerification
                                {
