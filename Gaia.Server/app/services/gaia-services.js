    ...
    (function (Services) {
        ...
        var MarketPlaceService = (function () {
            ...
            MarketPlaceService.prototype.removeServiceImage = function (uri, config) {
                return this.transport.delete('/api/market-place/merchants/services/images', {
                    Uri: uri
                }, config).then(function (opr) { return opr.data; });
            };
            MarketPlaceService.prototype.getServiceImages = function (itemId, config) {
            ...
            MarketPlaceService.prototype.removeProductImage = function (uri, config) {
                return this.transport.delete('/api/market-place/merchants/products/images', {
                    Uri: uri
                }, config).then(function (opr) { return opr.data; });
            };
